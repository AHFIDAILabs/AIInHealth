...
export type RequestMagicLinkInput = z.infer<typeof requestMagicLinkSchema>['body'];
...
// Email is deliberately excluded — it's the magic-link identity anchor, so changing
