...
import { requestMagicLink } from '../../services/delegate.service';
        ...
        {sent ? (
          <>
            ...
            <p className="mt-2 text-sm text-slate-500">
              If that email has a confirmed registration, we&rsquo;ve sent a sign-in link. It expires in 15 minutes.
            </p>
          </>
        ) : (
          <>
            ...
            <p className="mt-1.5 text-sm text-slate-500">
              Enter the email you registered with — we&rsquo;ll email you a sign-in link.
            </p>
