...
import { adminListSpeakers, TRACKS, type AdminSpeaker, type Track } from '../../services/speaker.service';
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-display text-2xl font-semibold text-navy">Sessions / Agenda</h1>
      ...
      {loading ? (
        ...
        <div className="mt-4 flex flex-col items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-card transition-shadow hover:shadow-card-hover py-20 text-center">
          ...
          <p className="mt-4 font-semibold text-navy">No sessions added yet</p>
